...
class Gas(Metric):
    ...
    url2 = "&startblock=0&endblock=99999999&page=1&offset=1&sort=desc&apikey=3SJEA6GFDBZNAGPYG26SRTR5JF9MW7DNCB"

    def getText(self, p, b):
        if b > 0:
            return f'{p} is the bigger pyromaniac, spending {b} GWEI..'
        else:
            return ' Neither of you are actually using Ethereum. SHAME! >:('
